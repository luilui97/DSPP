...
def get_tinyimagenet_dataloader(batch_size = 128, num_workers=8):
    train_dataset = get_tiny_imagenet(root = "./datasets/",split="train")
    val_dataset = get_tiny_imagenet(root = "./datasets/",split="train")
