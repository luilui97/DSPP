...
from dataset.tiny_imagenet import get_tinyimagenet_dataloader
...
def main():
    ...
    if opt.dataset == 'cifar100':
        ...
        train_loader, val_loader, _=get_tinyimagenet_dataloader(batch_size=opt.batch_size, num_workers=opt.num_workers)
        n_cls = 200
    else:
